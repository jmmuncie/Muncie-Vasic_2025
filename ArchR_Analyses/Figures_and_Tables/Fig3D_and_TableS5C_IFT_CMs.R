...
#Save dataframe to a CSV file - Table S5C
write.csv(DARs_P2G_with_DEG_info, "~/Desktop/Working_Directory/TableS5C_E85_IFT-CMs_DARs_P2G_with_DEG_info.csv", row.names = FALSE)
